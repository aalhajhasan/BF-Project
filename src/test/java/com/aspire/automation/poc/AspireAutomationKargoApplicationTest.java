...
import com.aspire.kargo.AspireAutomationKargoApplication;
...
@SpringBootTest(webEnvironment = WebEnvironment.DEFINED_PORT, classes = { AspireAutomationKargoApplication.class,
		AspireAutomationAutoconfigurationApplication.class }) 

public class AspireAutomationKargoApplicationTest extends AspireDefaultTestRunner {
