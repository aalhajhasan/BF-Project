...
And [1101-1181] the user saves llbeanPdpPrice text in global scope under name llbeanPdpPrice
...
And [1101-1140] llbeanBagPrice text should contain `llbeanPdpPrice`