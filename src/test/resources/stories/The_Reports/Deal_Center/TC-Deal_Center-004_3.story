Meta:
@DependOn |login|0|
Scenario: TC-Deal_Center-004.1 - verify pagination is working fine at Deal_Center page (50 row).
...
Scenario: TC-Deal_Center-004.2 - verify pagination is working fine at Deal_Center page(75 row).
...
Scenario: TC-Deal_Center-004.3 - verify pagination is working fine at Deal_Center page (100 row).
