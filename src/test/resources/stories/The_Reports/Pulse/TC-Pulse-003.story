Meta:
@reports
Scenario: TC-Pulse-003 - Verify export button is working fine at Revenue tab.
...
And Verify Advertiser_ExportButton working fine if there is Advertiser_Data to be export in Reports Page
