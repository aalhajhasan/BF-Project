Meta:
@reports
Scenario: TC-Pulse-002 - Verify user ability to navigate to Pulse-Revenue tab and verify tab elements.

Given I am On Reports_Page
When I click on Pulse_Button
And I click on Revenue_Tab
Then I verify Overview_Metric displays
...
And I verify Advertiser_ExportButton displays
