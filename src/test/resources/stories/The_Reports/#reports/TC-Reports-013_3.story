Meta:
@reports
Scenario: TC-Reports-013 - Verify user disability to navigate to Discrepancies previous page when at page no.1.

Given [1000-9000] User opens reports page
When [1100-1300] User clicks on the Next Arrow Button
...
Scenario: TC-Reports-013.2 - Verify user ability to navigate between Discrepancies pages using Next arrow.
Given [1000-9000] User opens reports page
When [1100-1300] User clicks on the Next Arrow Button
And [1100-1300] User clicks on the discrepanciesButton
And [1111-1020] Progress Dialog should not be visible, Within 30 seconds
...
Scenario: TC-Reports-013.3 - Verify user ability to navigate between Discrepancies pages using Previous arrow.
Given [1000-9000] User opens reports page
