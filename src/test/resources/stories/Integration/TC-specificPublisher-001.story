...
And [1100-1300] User clicks on the Invoices Tab
And [1100-1300] User clicks on the Add Year Button
...
And [1100-1300] User clicks on the Save Year Button
Then [1111-1100] Invoices Value text should equal to 24, Within 50 seconds
And [1211-1200] Add Year Fields should all have value equals to 2, Within 30 seconds
