...
And [1100-1340] User fills User First Name with `Automated Advertiser User First Name`
And [1101-0286] Save value in re-run scope under name last Created advertiser User
And [1100-1340] User fills User Email with `Autmated Advertiser User Email`
And [1100-1340] User fills User Phone Number with 0000111222
And [1100-1330] User enters DOWN as Keyboard input in User Company
...
And [1100-1330] User enters DOWN as Keyboard input in User Role
...
And [1100-1330] User enters DOWN as Keyboard input in Specific User Brand Name
...
And [1100-1300] User clicks on the First Option
...
And [1100-1340] User fills Search Box with `last Created advertiser User`
