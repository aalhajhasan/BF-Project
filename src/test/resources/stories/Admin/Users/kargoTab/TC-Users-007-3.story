...
When [8001-0009] User presses on Next Arrow Button, if page contains pagination
...
Given [1000-9001] User on User Common Elements page
When [8001-0009] User presses on Previous Arrow Button, if page contains pagination
