...
When [1101-1284] save Specific User value in scenario scope under name My User
And [1100-1300] User clicks on the Specific User
Then [1111-1100] Page Title text should equal to `My User`, Within 30 seconds
And [1111-1080] Search Box should be displayed, Within 50 seconds
