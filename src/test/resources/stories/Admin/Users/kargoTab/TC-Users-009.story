...
And [1101-1284] save Specific User value in scenario scope under name active User Name
And [1111-1000] Action Button should be clickable, Within 50 seconds
And [1100-1300] User clicks on the Action Button
And [1100-1300] User clicks on the Impersonate user From Action button
...
And [1100-1300] User clicks on the Stop Button
