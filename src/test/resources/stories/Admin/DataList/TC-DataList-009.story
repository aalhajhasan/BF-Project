...
Scenario:  TC-Data Lists-009 - Verify user ability to navigate to Ad Tag Release Groups page.

Given [1000-9001] User on dashboard page
When [1100-1371] User moves mouse to Admin Option and click on Data Lists Option
And [1100-1300] User clicks on the Ad Tag Release Groups Page Link
And [1111-1020] Progress Dialog should not be visible, Within 15 seconds
Then [1101-1100] Header Title text should equal to Ad Tag Release Groups
