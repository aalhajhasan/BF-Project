...
And [1111-1000] continueCheckoutButton should be clickable, Within 120 seconds
...
And [8003-0008] `orderTotal` price should be matched with the summation of `itemTotal` , `shipping` , `landedCost` and `dutiesAndTaxes`
